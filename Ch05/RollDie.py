# RollDie.py
"""Graphing frequencies of die rolls."""
...
# number_of_roles = int(sys.argv[1])
number_of_roles = 60000

# use list comprehension to create a list of rolls of a six-sided die
# rolls = [random.randrange(2, 13) for i in range(int(sys.argv[1]))]
rolls = [random.randrange(2, 13) for i in range(number_of_roles)]
